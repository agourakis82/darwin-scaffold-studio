...
"""
    compute_surface_area(volume::AbstractArray{Bool, 3}, voxel_size_um::Real) -> Float64

Compute surface area in mm².
"""
function compute_surface_area(volume::AbstractArray{Bool, 3}, voxel_size_um::Real)
...
"""
    compute_relative_density(volume::AbstractArray{Bool, 3}) -> Float64

Compute relative density (solid fraction).
"""
function compute_relative_density(volume::AbstractArray{Bool, 3})
